...
public class AscendingSortValue {

	// 3つの整数値の入力を読み込み、大きい方の値と、小さい方の値を出力する為の処理
			...
			if ( isIntB ){
				...
				if( isIntC ){
					...
					if ( isInt ){
						...
						// aには最小値が入っているはずなので b,cを比較して bがcより大きければ値を入れ替える
						if( b > c ) {
